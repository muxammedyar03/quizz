...
const MOCK_QUIZZES: Record<QuizLevel, QuizData> = {
  beginner: {
    level: "beginner",
...
export interface IStorage {
  getQuiz(level: QuizLevel): Promise<QuizData | undefined>;
}

export class MemStorage implements IStorage {
  async getQuiz(level: QuizLevel): Promise<QuizData | undefined> {
    return MOCK_QUIZZES[level];
  }
}
